...
namespace LauncherCaravansary
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            Debug.WriteLine(launcherApplicationPath);
            Debug.WriteLine(launcherApplicationDirectoryPath);
            ...
            try
            {
                ...
                fi.CopyTo(Path.Combine(launcherApplicationDirectoryPath, "Caravansary.exe"), true);
